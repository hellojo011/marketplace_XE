...
class marketplaceModel extends module
{
	...
	/**
	 * @brief return marketplace item list
	 * @param itemBaseObject $oDocument
	 *   document item BaseObject or marketplace item BaseObject
	 * @param stdClass $args
	 *  
	 **/
	...
	/**
	 * @brief return marketplace item BaseObject
	...
	function getAllKeywords($module_srl)
	{
		...
		{
			$BaseObject_key = 'keyword_list:' . $module_srl;
