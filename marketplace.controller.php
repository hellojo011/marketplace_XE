...
class marketplaceController extends marketplace
{
	...
	private function _insertDocument()
	{
		...
		// generate document module model BaseObject
		$oDocumentModel = getModel('document');

		// generate document module의 controller BaseObject
	...
	function procMarketplaceDeleteDocument()
	{
		...
		// generate document module controller BaseObject
		$oDocumentController = getController('document');
	...
	function procMarketplaceInsertComment()
	{
		...
		// generate comment  module model BaseObject
		$oCommentModel = getModel('comment');

		// generate comment module controller BaseObject
	...
	function procMarketplaceDeleteComment()
	{
		...
		// generate comment  controller BaseObject
		$oCommentController = getController('comment');
	...
	function procMarketplaceInsertKeyword()
	{
		...
		else
		{
			...
			{
				$BaseObject_key = 'keyword_list:' . $this->module_srl;
				$cache_key = $oCacheHandler->getGroupKey('marketplace', $BaseObject_key);
